/*!
 * SQLParser (v1.3.0)
 * @copyright 2012-2015 Spryker Sytems GmbH <info@spryker.com>
 * @copyright 2015-2023 Andy Kent <andy@forward.co.uk>
 * @licence MIT
 */
(function (global, factory) {
	...
	var SQL_OPERATORS = ['=', '!=', '>=', '>', '<=', '<>', '<', 'LIKE', 'CONTAINS', 'DOES NOT CONTAIN', 'IS IN', 'IS NOT IN'];
	var SUB_SELECT_OP = ['ANY', 'ALL', 'SOME'];
	...
	var Lexer = /*#__PURE__*/function () {
	  ...
	  _proto.postProcess = function postProcess() {
	    var results = [];
	    for (var i = 0, j = 0, len = this.tokens.length; j < len; i = ++j) {
	...
	*/
	...
	nodes.ListValue;
	nodes.WhitepaceList;
	nodes.ParameterValue;
	nodes.ArgumentListValue;
	nodes.BooleanValue;
	nodes.FunctionValue;
	nodes.Case;
	nodes.CaseWhen;
	...
	var parser = compiled_parser.parser;
	parser.lexer = {
	  lex: function lex() {
	    var tag;
